...
title: Information for xPack Windows Build Tools maintainers
...
xpm run deep-clean --config darwin-x64  -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets && \
xpm install --config darwin-x64 -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets && \
xpm run build-development --config darwin-x64 -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets
```

For a debug build:

```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets
```
...
```sh
bash ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
[Travis CI](https://app.travis-ci.com/github/xpack-dev-tools/windows-build-tools-xpack/builds/).
...
named like **xPack Windows Build Tools v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/windows-build-tools</code>
- <code>npm dist-tag add @xpack-dev-tools/windows-build-tools@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/windows-build-tools</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/windows-build-tools@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/windows-build-tools-xpack/blog/
...
- paste the release name like _**xPack Windows Build Tools v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
...
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/windows-build-tools.svg)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/windows-build-tools.svg)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
