...
* <code>xpack-windows-build-tools-{customField('xpackVersion')}-{props.platform}.tar.gz</code>
* <code>xpack-windows-build-tools-{customField('xpackVersion')}-{props.platform}.tar.gz.sha</code>
