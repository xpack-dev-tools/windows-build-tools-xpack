...
# How to get help for the xPack Windows Build Tools
...
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/windows-build-tools-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/windows-build-tools-xpack/discussions)
pages.
