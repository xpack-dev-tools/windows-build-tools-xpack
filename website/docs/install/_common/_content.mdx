...
The **xPack Windows Build Tools** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack Windows Build Tools
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/windows-build-tools@4.4.1-4.1 --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/windows-build-tools/4.4.1-4.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-windows-build-tools-4.4.1-4-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\windows-build-tools\\xpack-windows-build-tools-4.4.1-4</code>.
