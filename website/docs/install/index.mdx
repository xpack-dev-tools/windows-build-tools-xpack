...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fwindows-build-tools?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/windows-build-tools-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fwindows-build-tools?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
...
* add <code>@xpack-dev-tools/windows-build-tools</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack Windows Build Tools with
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/windows-build-tools/4.4.1-3.1/.content/bin:$PATH
`} </CodeBlock>
