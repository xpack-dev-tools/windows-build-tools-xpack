...
* identify the platform specific archive for the latest available version
  of Windows Build Tools, download it into a cache and unpack
...
* add <code>@xpack-dev-tools/windows-build-tools</code> to
  `package.json` as a
  development dependency; this associates a specific version of Windows Build Tools with
...
it is also possible to install Windows Build Tools only globally in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/windows-build-tools /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/windows-build-tools /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/windows-build-tools /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
* <code>xpack-windows-build-tools-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip</code>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\windows-build-tools\\xpack-windows-build-tools-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>.
...
The macOS versions of **xPack Windows Build Tools**
are packed as `.tar.gz` archives.
Download the latest version named like:

* <code>xpack-windows-build-tools-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-windows-build-tools-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
...
The recommended location is
the <code>~/Library/xPacks/windows-build-tools</code> folder, for
example <code>/Users/ilg/Library/xPacks/windows-build-tools/xpack-windows-build-tools-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/windows-build-tools
cd ~/Library/xPacks/windows-build-tools

tar xvf ~/Downloads/xpack-windows-build-tools-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-darwin-x64.tar.gz
chmod -R -w xpack-windows-build-tools-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>

</TabItem>
<TabItem value="linux" label="GNU/Linux">

The GNU/Linux versions of **xPack Windows Build Tools**
are packed as `.tar.gz` archives.
Download the latest version named like:
...
The recommended location is
the <code>~/.local/xPacks/windows-build-tools</code> folder, for
example <code>/home/ilg/.local/xPacks/windows-build-tools/xpack-windows-build-tools-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/windows-build-tools
cd ~/.local/xPacks/windows-build-tools

tar xvf ~/Downloads/xpack-windows-build-tools-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-linux-x64.tar.gz
chmod -R -w xpack-windows-build-tools-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
