...
- **Push** the `website` branch to GitHub
  ...
  the [website](https://xpack-dev-tools.github.io/windows-build-tools-xpack/).
  :::
- Check out the `xpack-development` branch
- **Wait** for the publication to complete 
- check [GitHub Pages](https://github.com/xpack-dev-tools/windows-build-tools-xpack/actions/workflows/publish-github-pages.yml) workflow
