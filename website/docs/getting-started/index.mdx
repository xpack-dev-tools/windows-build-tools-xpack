...
title: Getting Started with the xPack Windows Build Tools
...
[`windows-build-tools-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/windows-build-tools-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/windows-build-tools-xpack/): It helps others discover our work.
