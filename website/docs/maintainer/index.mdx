...
- determine the version (like <code>4.4.1-3.1</code>)
- update the version in top `package.json`
- use the new version, suffixed by `.pre`,
like <code>4.4.1-3.1.pre</code>.
...
Determine the version (like <code>4.4.1-3</code>)
and update the `build-assets/scripts/VERSION` file; the format
is <code>4.4.1-3</code>.
...
and fix them; assign them to a milestone (like <code>4.4.1-3</code>).
...
- add a new entry like _**\* v4.4.1-3 prepared**_
- commit with the message _**prepare v4.4.1-3**_
...
(like **4.4.1**) with the following expression:
...
For `xbbli`, which has more memory, start two runners:
...
tagged like **v4.4.1-3** (mind the dash in the middle!) and
named like **xPack Windows Build Tools v4.4.1-3** (mind the dash),
...
watching the windows-build-tools-xpack project.
...
- commit with the message _**website: blog post release 4.4.1-3 published**_
...
- commit all changes with the message
  _**package.json: update urls for 4.4.1-3.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v4.4.1-3.1 published on npmjs.com**_
- commit with the message _**CHANGELOG: publish npm v4.4.1-3.1**_
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools?activeTab=versions">npmjs.com</a>.
...
in https://xpack-dev-tools.github.io/windows-build-tools-xpack/blog/
- remember the post URL, since it must be used to update the release page
and the X/Twitter announcement
- switch to https://xpack-dev-tools.github.io/windows-build-tools-xpack/docs/maintainer/#update-the-xpack-branch
...
- paste the release name like _**xPack Windows Build Tools v4.4.1-3 released**_
...
- GitHub [`xpack-dev-tools/windows-build-tools-xpack`](https://github.com/xpack-dev-tools/windows-build-tools-xpack/) repo
...
- npmjs.com [`@xpack-dev-tools/windows-build-tools`](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/) xPack
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/@xpack-dev-tools/windows-build-tools)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/windows-build-tools)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/windows-build-tools)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
