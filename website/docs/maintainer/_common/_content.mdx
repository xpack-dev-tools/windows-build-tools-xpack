...
```sh
npm run generate-workflows -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git
```
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fwindows-build-tools?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fwindows-build-tools)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fwindows-build-tools)](https://www.npmjs.com/package/@xpack-dev-tools/windows-build-tools/)
