...
xpm run docker-prepare --config ${props.platform} -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets && \\
xpm run docker-link-deps --config ${props.platform} -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets && \\
xpm run docker-build-development --config ${props.platform} -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets
`} </CodeBlock>
...
- <code>xpack-windows-build-tools-4.4.1-4-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}</code>
- <code>xpack-windows-build-tools-4.4.1-4-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}.sha</code>
...
xpm run deep-clean --config ${props.platform}  -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets && \\
xpm run docker-prepare --config ${props.platform} -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets && \\
xpm run docker-build --config ${props.platform} -C ~/Work/xpack-dev-tools/windows-build-tools-xpack.git/build-assets
`} </CodeBlock>
