...
seo_title: Version 4.4.0-1 released
description: Version 4.4.0-1 is a new release of xPack Windows Build Tools.
keywords:
  - xpack
  - windows-build-tools
  - release
...
DEPRECATED: Version **4.4.0-1** is a new release of the **xPack Windows Build Tools** package, following the make release.
