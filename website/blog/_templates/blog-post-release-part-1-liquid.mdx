...
download_url: https://github.com/xpack-dev-tools/windows-build-tools-xpack/releases/tag/v{{xpackVersion}}/
...
```sh
.../xpack-windows-build-tools-{{xpackVersion}}/bin/make --version
```
