...
file; the format is `4.2.1-4`. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like `4.2.1-4`).
...
- add a new entry like _- v4.2.1-4 prepared_
- commit with a message like _prepare v4.2.1-4_
...
- in `CHANGELOG.md`, add the release date and a message like _- v4.2.1-4 released_
- commit and push the `xpack-develop` branch
- run the xPack action `trigger-workflow-publish-release`

The result is a
[draft pre-release](https://github.com/xpack-dev-tools/windows-build-tools-xpack/releases/)
tagged like **v4.2.1-4** (mind the dash in the middle!) and
named like **xPack Windows Build Tools v4.2.1-4** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like **xPack Windows Build Tools v4.2.1-4 released**
- push to GitHub
...
- commit all changes, use a message like
  `package.json: update urls for 4.2.1-4.1 release` (without `v`)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _- v4.2.1-4.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v4.2.1-4.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 4.2.1-4.1`; the first 5 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/windows-build-tools@4.2.1-4.1 latest`
- `npm dist-tag ls @xpack-dev-tools/windows-build-tools`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/windows-build-tools@4.2.1-4.X`
...
- paste the release name like **xPack Windows Build Tools v4.2.1-4 released**
