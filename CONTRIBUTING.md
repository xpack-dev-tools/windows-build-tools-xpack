...
If you are convinced you identified a bug (if you have doubts, use the forum), or you have a pertinent suggestion how to enhance the GNU MCU Eclipse **Windows Build Tools**, please use the [GitHub Issues](https://github.com/gnu-mcu-eclipse/windows-build-tools/issues) tracker.

Be sure you report only issues related to the GNU MCU Eclipse **Windows Build Tools**. **DO NOT** use it for issues related to the plug-ins or the other tools (QEMU, OpenOCD, etc), which should be addressed to their corresponding trackers. Web content issues should be addressed to the [Web Issues](https://github.com/gnu-mcu-eclipse/gnu-mcu-eclipse.github.io-support/issues/) tracker. J-Link specific questions should be addresses to SEGGER support.
